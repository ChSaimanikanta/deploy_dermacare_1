...
public class DoctorServiceImpl implements DoctorService {
	...
	public Response login(DoctorLoginDTO loginDTO) {
		...
		if (credentialsOptional.isPresent()) {
			...
			if (matches) {
				credentials.setDeviceId(loginDTO.getDeviceId());
				credentials.setFcmToken(loginDTO.getFcmToken());
				DoctorLoginCredentials savedToken = credentialsRepository.save(credentials);
				DoctorLoginDTO dto = new DoctorLoginDTO();
				dto.setUsername(savedToken.getUsername());
				dto.setPassword(savedToken.getPassword());
				dto.setFcmToken(savedToken.getFcmToken());
				dto.setDeviceId(savedToken.getDeviceId());
				dto.setDoctorId(savedToken.getDoctorId());
				dto.setHospitalId(savedToken.getHospitalId());
