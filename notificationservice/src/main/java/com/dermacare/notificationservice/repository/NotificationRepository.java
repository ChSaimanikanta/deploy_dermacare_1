...
public interface NotificationRepository extends MongoRepository<NotificationEntity, String> {
	...
	public NotificationEntity findByDataBookingId(String bookingId);

	public List<NotificationEntity> findByDataNameAndDataMobileNumber(String customerName, String customerMobileNumber);
